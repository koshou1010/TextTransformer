...
class TextTransformerType1:
    ...
    def open_file(self):
        '''
        use for open file and read eachline
        '''
    ...
    def save_data(self,each_line):
        '''
        use for save eachline data to ndjson format
        '''
    ...
    def find_first_time(self):
        '''
        use for find first time to file meta use
        '''
    ...
    def make_fake_preset_meta(self):
        '''
        use for make preset meta, if not preset meta, ESRTSD can't transfer voltage to resistance
        '''
